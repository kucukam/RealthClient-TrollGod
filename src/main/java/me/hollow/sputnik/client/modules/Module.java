...
public class Module implements IListener {
    ...
    public final void setEnabled(boolean enabled) {
        ...
        if (enabled) {
            onEnable();
            MessageUtil.sendClientMessage(ChatFormatting.DARK_AQUA + this.getLabel() + "\u00a7d was \u00a72\u00a7lenabled", -44444);
        } else {
            onDisable();
            MessageUtil.sendClientMessage(ChatFormatting.DARK_AQUA + this.getLabel() + "\u00a7d was \u00a74\u00a7ldisabled", -44444);
        }
    }
