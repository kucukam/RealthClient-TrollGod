...
public class ClickGui extends Module {
    ...
    public final Setting<Integer> categoryGreen = register(new Setting<>("Category Green", 255, 0, 255));
    public final Setting<Integer> categoryBlue = register(new Setting<>("Category Blue", 255, 0, 255));
    public final Setting<Integer> categoryAlpha = register(new Setting<>("Category Alpha", 40, 0, 255));

    public final Setting<Integer> alpha = register(new Setting<>("Alpha", 40, 0, 255));
