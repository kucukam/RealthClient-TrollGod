...
public class Offhand extends Module {
    ...
    private boolean shouldTotem() {
        ...
        return mc.player.getHealth() + mc.player.getAbsorptionAmount() <= getHealth() || !Sputnik.INSTANCE.getSafeManager().isSafe() || mc.player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == Items.ELYTRA;
    }
