...
public class Slider extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Sputnik.fontManager.drawString(getName() + " " + ChatFormatting.GRAY + (setting.getValue() instanceof Float ? ((Number)setting.getValue()) : ((Number)setting.getValue()).doubleValue()), x + 2F, y - 1F - TrollGui.getClickGui().getTextOffset(), 0xFFFFFFFF);
    }
