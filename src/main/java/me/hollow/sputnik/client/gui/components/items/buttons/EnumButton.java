...
public class EnumButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Sputnik.fontManager.drawString(setting.getName() + " " + ChatFormatting.GRAY + setting.currentEnumName(), x + 2.3F, y - 1.7F - TrollGui.getClickGui().getTextOffset(), getState() ? 0xFFFFFFFF : 0xFFAAAAAA);
    }
